                        ...
                        @auth
                            ...
                            @if ($isExist)
                                <a class="wsus__pro_report" href="#" data-bs-toggle="modal"
                                    ...
                                    {{ __('Report incorrect product information') }}</a>
                            @endif
                                                    ...
                                                    <div class="col-12">
                                                        <form id="reportModalForm">
                                                            ...
                                                            <div class="wsus__single_input">
                                                                ...
                                                                <textarea name="description" cols="3" rows="3" placeholder="{{ __('Description') }}"></textarea>
                                                            </div>

                                                            <button type="submit"
                                                                class="common_btn">{{ __('submit') }}</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-8 col-lg-7">
                                                <div class="wsus__comment_area">
                                                    <h4>{{ __('Reviews') }} <span>{{ $totalProductReviewQty }}</span>
                                                    </h4>
                                                            ...
                                                            <div class="col-xl-12">
                                                                <div class="col-xl-12">
                                                                    <div class="wsus__single_com">
                                                                        <textarea name="review" cols="3" rows="3" placeholder="{{ __('Write your review') }}"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="wsus__section_header">
                            ...
                            <a class="see_btn"
                                href="{{ route('product', ['category' => $product->category->slug]) }}">{{ __('see more') }}
                ...
                <form id="productModalFormId-{{ $relatedProduct->id }}">
                    <div class="wsus__quentity">
                        ...
                        <div class="modal_btn">
                            ...
                            <button onclick="productModalIncrement('{{ $relatedProduct->id }}')" type="button"
                    ...
                    <ul class="wsus__button_area">
                        <li><button type="button" onclick="addToCartInProductModal('{{ $relatedProduct->id }}')"
                                class="add_cart">{{ __('add to cart') }}</button></li>
                        <li><a class="buy_now" href="javascript:;"
                                onclick="addToBuyNow('{{ $relatedProduct->id }}')">{{ __('buy now') }}</a></li>
