                            ...
                            @foreach ($productCategories as $productCategory)
                                @if ($productCategory->subCategories->count() == 0)
                                    <li><a href="{{ route('product', ['category' => $productCategory->slug]) }}"><i
                                                class="{{ $productCategory->icon }}"></i> {{ $productCategory->name }}</a>
                                    </li>
                                @else
                    ...
                    <div class="col-xl-3 col-sm-6 col-md-6 col-lg-4 _featured">
                        <div class="wsus__product_item">
                            ...
                            <div class="wsus__product_details">
                                ...
                                <a class="buy_button" onclick="addToBuyNow('{{ $featuredProduct->id }}')"
                                    href="javascript:;">{{ __('user.Order Now') }} </a>
                    ...
                    <div class="col-xl-3 col-sm-6 col-md-6 col-lg-4">
                        <div class="wsus__product_item">
                            ...
                            <div class="wsus__product_details">
                                ...
                                <a class="buy_button" onclick="addToBuyNow('{{ $bestProduct->id }}')"
                                    href="javascript:;">{{ __('user.Order Now') }} </a>
                    ...
                    <div class="col-xl-3 col-sm-6 col-md-6 col-lg-4 _top">
                        <div class="wsus__product_item ">
                            ...
                            <div class="wsus__product_details">
                                ...
                                <a class="buy_button" onclick="addToBuyNow('{{ $topProduct->id }}')"
                                    href="javascript:;">{{ __('user.Order Now') }} </a>
                    ...
                    <div class="col-xl-3 col-sm-6 col-md-6 col-lg-4 _new">
                        <div class="wsus__product_item wsus__after">
                            ...
                            <div class="wsus__product_details">
                                ...
                                <a class="buy_button" onclick="addToBuyNow('{{ $newProduct->id }}')"
                                    href="javascript:;">{{ __('user.Order Now') }} </a>
