        ...
        <ul class="sidebar-menu">
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li
                        ...
                        <a class="nav-link"
                            href="{{ route('admin.mega-menu-category.index') }}">{{ __('admin.Mega Menu Category') }}</a>
                    </li>
                    <li class="{{ Route::is('admin.popular-category') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.popular-category') }}">{{ __('admin.Popular Category') }}</a></li>

                    <li class="{{ Route::is('admin.featured-category') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.featured-category') }}">{{ __('admin.Featured Category') }}</a></li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="nav-link {{ Route::is('admin.product-import-page') ? 'active' : '' }}"
                            href="{{ route('admin.product-import-page') }}">{{ __('admin.Product Bulk Import') }}</a>
                    </li>

                    <li><a class="nav-link  {{ Route::is('admin.product.create') ? 'active' : '' }}"
                            href="{{ route('admin.product.create') }}">{{ __('admin.Create Product') }}</a></li>

                    <li
                        class="{{ (Route::is('admin.product.*') || Route::is('admin.product-variant') || Route::is('admin.create-product-variant') || Route::is('admin.edit-product-variant') || Route::is('admin.product-gallery') || Route::is('admin.product-variant-item') || Route::is('admin.create-product-variant-item') || Route::is('admin.edit-product-variant-item') || Route::is('admin.wholesale') || Route::is('admin.create-wholesale') || Route::is('admin.edit-wholesale') || Route::is('admin.product-highlight')) && !Route::is('admin.product.create') ? 'active' : '' }}">
            ...
            <li
                class="nav-item dropdown {{ Route::is('admin.state.*') || Route::is('admin.city.*') || Route::is('admin.country-import-page') || Route::is('admin.state-import-page') || Route::is('admin.city-import-page') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i
                        class="fas fa-map-marker-alt"></i><span>{{ __('admin.Locations') }}</span></a>

                <ul class="dropdown-menu">
                    <li class="{{ Route::is('admin.state.*') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.state.index') }}">{{ __('admin.State / Province') }}</a></li>

                    <li class="{{ Route::is('admin.city.*') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.city.index') }}">{{ __('admin.City / Delivery Area') }}</a></li>

                </ul>
            </li>

            <li
                class="nav-item dropdown {{ Route::is('admin.flash-sale') || Route::is('admin.currency.*') || Route::is('admin.shipping.*') || Route::is('admin.coupon.*') || Route::is('admin.payment-method') || Route::is('admin.flash-sale-product') || Route::is('admin.shipping-import-page') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i
            ...
            <li
                class="nav-item dropdown {{ Route::is('admin.service.*') || Route::is('admin.announcement') || Route::is('admin.slider.*') || Route::is('admin.home-page') || Route::is('admin.banner-image.index') || Route::is('admin.homepage-one-visibility') || Route::is('admin.cart-bottom-banner') || Route::is('admin.shop-page') || Route::is('admin.seo-setup') || Route::is('admin.menu-visibility') || Route::is('admin.product-detail-page') || Route::is('admin.default-avatar') || Route::is('admin.seller-conditions') || Route::is('admin.subscription-banner') || Route::is('admin.testimonial.*') || Route::is('admin.homepage-section-title') || Route::is('admin.image-content') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Route::is('admin.homepage-section-title') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.homepage-section-title') }}">{{ __('admin.Homepage Section Title') }}</a>
                    </li>
                    ...
                    <li class="{{ Route::is('admin.image-content') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.image-content') }}">{{ __('admin.Image Content') }}</a></li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Route::is('admin.error-page.*') ? 'active' : '' }} d-none"><a class="nav-link"
            ...
            <li
                class="nav-item dropdown {{ Route::is('admin.sms-notification') || Route::is('admin.sms-template') || Route::is('admin.edit-sms-template') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i
                        class="fas fa-envelope"></i><span>{{ __('admin.Sms Configuration') }}</span></a>

                <ul class="dropdown-menu">
                    <li class="{{ Route::is('admin.sms-notification') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin.sms-notification') }}">{{ __('admin.Setting') }}</a></li>
