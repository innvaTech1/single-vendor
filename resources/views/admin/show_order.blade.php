...
@section('admin-content')
                ...
                <div class="invoice">
                    <div class="invoice-print">
                                    ...
                                    @if ($order->deliveryman)
                                        <div class="col-md-6">
                                            <address>
                                                ...
                                                {{ __('Name') }}: {{ $order->deliveryman->fname }}
                                                {{ $order->deliveryman->lname }}<br>
                                                {{ __('admin.Status') }} :
                        ...
                        <div class="row mt-4">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="count">
                                                        <div class="mainas">
                                                            <p>
                                                                <a
                                                                    href="{{ route('admin.order-quantity-decrement', [$orderProduct->id, $order->id]) }}">
                                                                    <span>
                                                        ...
                                                        <div class="count-text">
                                                            <input type="number" name="qty_update[289]"
                                                                value="{{ $orderProduct->qty }}" fdprocessedid="hj0efo">
                                                        </div>
                                                        <div class="plus">
                                                            <p>
                                                                <a
                                                                    href="{{ route('admin.order-quantity-increment', [$orderProduct->id, $order->id]) }}">
                                                                    <span>
                                                ...
                                                <td class="text-right delete-icon">
                                                    <a href="javascript:;" data-toggle="modal" data-target="#deleteModal"
                                                        ...
                                                        onclick="deleteData({{ $orderProduct->id }},{{ $order->id }})"><i
                                    ...
                                    <div class="col-lg-6 text-right">
                                        ...
                                        <div class="invoice-detail-item">
                                            <div class="invoice-detail-name">{{ __('admin.Subtotal') }} :
                                                {{ $setting->currency_icon }}{{ round($sub_total, 2) }}</div>
                                        </div>
                                        <div class="invoice-detail-item">
                                            <div class="invoice-detail-name">{{ __('admin.Discount') }}(-) :
                                                {{ $setting->currency_icon }}{{ round($order->coupon_coast, 2) }}</div>
                                        </div>

                                        <div class="invoice-detail-item">
                                            <div class="invoice-detail-name">{{ __('admin.Shipping') }} :
                                                {{ $setting->currency_icon }}{{ round($order->shipping_cost, 2) }}</div>
                                        </div>
                                        ...
                                        <div class="invoice-detail-item">
                                            <div class="invoice-detail-value invoice-detail-value-lg">
                                                {{ __('admin.Total') }} :
                                                {{ $setting->currency_icon }}{{ round($grand_total, 2) }}</div>
                                        </div>
                                    </div>
                            ...
                            <div class="row mt-3 new-product">
                                <div class="col-lg-12">
                                    ...
                                    <form action="{{ route('admin.add-new-product-in-order', $order->id) }}"
                                        method="POST">
                                        @csrf
                                        <div class="form-group">
                        ...
                        <div class="text-md-right print-area">
                            <hr>
                            <button class="btn btn-success btn-icon icon-left print_btn"><i class="fas fa-print"></i>
                                {{ __('admin.Print') }}</button>
    ...
    <!-- Modal -->
    <div class="modal fade" id="exampleModalLong-2" role="dialog" aria-labelledby="exampleModalLongTitle"
        aria-hidden="true">
